...
| 3, not 308                    | Canonicalisation is off, or `public/_redirects` stopped being applied. A **307** specifically means Cloudflare fell back to `html_handling`, which emits a temporary redirect where a permanent one belongs — see #1494.                          |
