...
<section class="text-gray-700">
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center" data-aos="fade-in">
      ...
      <a href="<?= $event->url() ?>" class="inline-flex text-white bg-tap-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-tap-red-800 rounded text-lg">Mehr erfahren</a>
    </div>
