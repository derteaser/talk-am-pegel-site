      ...
      <div class="-my-8">
        <div class="py-8 flex flex-wrap md:flex-nowrap">
          <div class="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
            <span class="tracking-widest font-medium text-gray-900 dark:text-gray-100"><?= $event->date()->toDate('%e. %B %Y') ?></span>
          ...
          <div class="md:flex-grow">
            ...
            <p class="leading-relaxed"><?= Str::excerpt($event->text()->toBlocks()->first(), 400, true) ?></p>
