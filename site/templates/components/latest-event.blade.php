...
<section class="flex flex-col space-y-16 my-24">
    <article class="container mx-auto px-5 grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-5 gap-6">
        ...
        <div class="lg:col-span-2 xl:col-span-3 flex flex-col items-start space-y-8 aos" x-data="{ visible: false }"
            ...
            <h1 class="sm:text-4xl text-3xl font-semibold text-base-content">
                <a href="{{ $event->url() }}" class="link link-hover decoration-accent">{!! $event->title()->widont() !!}</a>
            </h1>
